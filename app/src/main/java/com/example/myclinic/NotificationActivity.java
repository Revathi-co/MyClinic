...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore.collection("Doctors").document(current_id).collection("Notification").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
             ...
             for(DocumentSnapshot snapshot : queryDocumentSnapshots){
                 ...
                 userId.add(snapshot.getString("from"));
                        ...
                        if (notificationTitle.isEmpty()) {
                            ...
                            CustomAdapter customAdapter = new CustomAdapter(NotificationActivity.this, notificationTitle, notificationMsg, userId);
    ...
    class CustomAdapter extends BaseAdapter {
        ...
        CustomAdapter(Context c, ArrayList<String> notificationTitle, ArrayList<String> notificationsMsg, ArrayList<String> userId) {
            this.c = c;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(notificationTitle.get(position).equals("Appointment Request")){
                    ...
                    }else if(notificationTitle.get(position).equals("Door-step Treatment Request")&& notificationTitle.get(position).equals("Emergency visit Request")){
                        Intent intent = new Intent(NotificationActivity.this, DoorStepActivity.class);
                        intent.putExtra("UserId",userId.get(position));
